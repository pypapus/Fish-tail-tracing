...
st.success("MobileSAM only — calibrated against 9 researcher-drawn ROIs")
st.caption(
    "MobileSAM owns the outer tail boundary. The researcher samples rank candidate masks "
    "and calibrate the separate notochord landmark; they do not redraw the outer fin edge."
)
tail_model = "mobilesam"
