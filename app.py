...
st.title("🐟 Fish Tail Boundary Agent — Preprocessing Test 1")
st.write(
    "Upload Zeiss `.czi` microscopy files. This experimental build tests background correction and texture suppression before tracing. The agent will detect the brightfield "
