...
class FishTailAgent:
    ...
    def process_file(self, filepath: Path, output_dir: Optional[Path] = None) -> Dict[str, Any]:
        ...
        self._log(f"Processing: {filepath.name} | build=TEST2_FIXED_2026-09-09")
        ...
        record = {
            "file_metadata": {
                ...
                "agent_build": "TEST2_FIXED_2026-09-09",
            ...
            "processing_notes": {
                ...
                "test2_status": "active" if seg.get("method") == "boundary_continuation_test2" else "attempted_but_fallback_selected",
                "test2_selected_method": seg.get("method"),
            },
        }
