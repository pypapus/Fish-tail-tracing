...
class FishTailAgent:
    ...
    def process_file(self, filepath: Path, output_dir: Optional[Path] = None) -> Dict[str, Any]:
        ...
        self._log(f"Processing: {filepath.name} | build=FINAL_NOTOCHORD_STAINGUIDED_2026-09-16")
        ...
        if model_result.get("success"):
            ...
            segmentation = {
                ...
                "method": "mobilesam_notochord_cutoff",
                "model_source": "mobilesam",
                "threshold": None,
                "polarity": "model_mask_plus_vertical_notochord_cutoff",
        ...
        record = {
            "file_metadata": {
                ...
                "agent_build": "FINAL_NOTOCHORD_STAINGUIDED_2026-09-16",
