...
st.title("🐟 Fish Tail Boundary Analysis Agent")
st.write(
    "Upload Zeiss `.czi` microscopy files. The agent will detect the brightfield "
...
run = st.button("Run analysis", type="primary", disabled=not uploaded)
